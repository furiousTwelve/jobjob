	...
	public PanelStatistique (){
		...
		//Jtable qui va récupérer le résultat de la requete  SELECT * FROM candiat.....
               ...
               Object []colonne={" Nom du candidat","Prénom du candidat","Date de test","Score/15"};
						...
						public void actionPerformed(ActionEvent e) {
							...
							while (selected ==false){
								...
								if (i<0){
									...
									jop1.showMessageDialog(null, "Merci de choisissez un candidat dans la liste", "Attention", JOptionPane.WARNING_MESSAGE);
				...
				// cette méthode supprime un candidat de la liste, reste a ajpouter la requete de suppression, a voir avec la couche données
				...
				supprimer.addActionListener(new ActionListener(){
					...
					public void actionPerformed(ActionEvent e) {
						...
						model.removeRow(i);
							...
							jop1 = new JOptionPane();
							jop1.showMessageDialog(null, "Merci de choisir le candidat à supprimer!", "Attention", JOptionPane.WARNING_MESSAGE);
						}
					}
				});
				...
				comparer_candidat.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						jop1 = new JOptionPane();
						jop1.showMessageDialog(null, "Merci de choisir deux candidats dans la liste!", "Attention", JOptionPane.WARNING_MESSAGE);
						 new ComparerCandidat();
					       }
