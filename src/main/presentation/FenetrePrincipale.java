 ...
 * 
 * <ul>
 * <li>Un panneau sera déclaré pour chaque interface/étape de l'application ...
 * </li>
 * </ul>
 * 
 * @author Mathieu
...
public class FenetrePrincipale extends JFrame implements ActionListener 
{
	 ...
	 *             Si jamais il y a un problème d'environnement avec le clavier
	 *             et/ou souris
	...
	/**
	 * Fonction qui récupère tous les ActionListener de tous les panneaux,
	 * issues des différents fichiers
	 * 
	 * @param arg0
	 *            Ce paramètre va permettre d'ouvrir un panneau selon les
	...
	public void actionPerformed(ActionEvent arg0)
	{
		...
		if (arg0.getSource() == panConnection.boutonQuitter) {System.exit(0);}

		/**
		 * @author Lionel
		 * @author autres personnes precedentes. Description : ci dessous on
		 *         gère le formulaire en fonction de l'item du menu sélectionné
		...
		// Seconde possibilité, c'est un candidat existant, seul le champ N°
		 ...
		 * <br>
		 * la validité du prenom et du nom est géré ici via une méthode de
		 * panFormulaire. <br>
		 * la validité du mail et du téléphone sont géré ici. <br>
		 * Si l'un des deux ou les deux sont faux, on ne peut pas enregistrer.
		...
		if (compteurQuestions == 16) 
		{
			 ...
			 * 
			 *         On creer une methode interne qui ouvre une nouvelle fenetre puis la referme. 
			 * 
			 */
	...
	// {
	// JOptionPane.showMessageDialog(null, "Cette interface n'est pas développée
	// - en attente de l'équipe Projet");
	// }
	...
	// =============================================== Fonctions créées
	// initialement par David, non utilisées pour l'instant, mais elles sont
	// peut-être poas là pour rien
	// =====================================================
	/**
	 * Constructeur non utilisé sous la version 1.00 à 1.xx
	 * 
	 * @deprecated Depuis v1.00, remplacé par FenetrePrincipale() throws
	 *             HeadlessException
	 */
